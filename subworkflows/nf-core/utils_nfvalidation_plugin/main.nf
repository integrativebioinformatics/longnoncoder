...
workflow UTILS_NFVALIDATION_PLUGIN {
    ...
    //
    if (print_help) {
        log.info paramsHelp(workflow_command, parameters_schema: schema_filename) + post_help_text
        System.exit(0)
    }
    ...
    //
    log.info paramsSummaryLog(workflow, parameters_schema: schema_filename) + post_help_text
